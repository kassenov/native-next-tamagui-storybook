...
var require_cjs9 = __commonJS({
  "../../node_modules/@tamagui/get-token/dist/cjs/index.js"(exports, module2) {
    ...
    var stepTokenUpOrDown = /* @__PURE__ */ __name((type, current, options = defaultOptions) => {
      ...
      const isString = typeof current == "string", tokensOrdered = (options.excludeHalfSteps ? isString ? cacheWholeKeys : cacheWholeVariables : isString ? cacheKeys : cacheVariables)[type], min3 = ((_a = options.bounds) == null ? void 0 : _a[0]) ?? 0, max3 = ((_b = options.bounds) == null ? void 0 : _b[1]) ?? tokensOrdered.length - 1, currentIndex = tokensOrdered.indexOf(current);
      let shift2 = options.shift || 0;
      shift2 && (current === "$true" || (0, import_web16.isVariable)(current) && current.name === "true") && (shift2 += shift2 > 0 ? 1 : -1);
      const index3 = Math.min(max3, Math.max(min3, currentIndex + shift2)), found = tokensOrdered[index3];
  ...
  "../../node_modules/react-remove-scroll/dist/es5/UI.js"(exports) {
    ...
    var RemoveScroll2 = React39.forwardRef(function(props, parentRef) {
      ...
      return React39.createElement(
        React39.Fragment,
        null,
        enabled && React39.createElement(SideCar, { sideCar: medium_1.effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }),
...
var require_SideEffect = __commonJS({
  "../../node_modules/react-remove-scroll/dist/es5/SideEffect.js"(exports) {
    ...
    function RemoveScrollSideCar(props) {
      ...
      var Style = React39.useState(function() {
      ...
      return React39.createElement(
        ...
        removeScrollBar ? React39.createElement(react_remove_scroll_bar_1.RemoveScrollBar, { gapMode: "margin" }) : null
      );
    }
    ...
    ({ __scopeSheet, ...props }) => {
      ...
      return context.onlyShowFrame ? null : (
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          ...
          {
            onPress: () => {
              const max3 = context.snapPoints.length + (context.dismissOnSnapToBottom ? -1 : 0), nextPos = (context.position + 1) % max3;
...
function useButton(propsIn, { Text: Text4 = Button2.Text } = { Text: Button2.Text }) {
  const isNested = (0, import_react24.useContext)(ButtonNestingContext), propsActive = (0, import_web9.useProps)(propsIn), {
    children,
    icon,
    iconAfter,
    space,
  ...
  }), [themedIcon, themedIconAfter] = [icon, iconAfter].map(getThemedIcon), spaceSize = propsActive.space ?? (0, import_web9.getVariableValue)(iconSize) * scaleSpace, contents = noTextWrap ? [children] : wrapChildrenInText(
    Text4,
    { children, fontFamily, fontSize },
    Text4 === ButtonText && propsIn.unstyled !== true ? {
      unstyled: false,
      size: size2
    } : void 0
...
var Progress = (0, import_core25.withStaticProperties)(
  ProgressFrame.styleable(function(props, forwardedRef) {
    const {
      ...
      size: size2 = "$true",
      ...progressProps
    } = props, max3 = isValidMaxNumber(maxProp) ? maxProp : DEFAULT_MAX, value = isValidValueNumber(valueProp, max3) ? valueProp : null, valueLabel = isNumber(value) ? getValueLabel(value, max3) : void 0, [width, setWidth] = React21.useState(0);
  ...
  (props, forwardedRef) => {
    ...
    function updateValues(value2, atIndex) {
      const decimalCount = getDecimalCount(step), snapToStep = roundValue(
        ...
        decimalCount
      ), nextValue = clamp(snapToStep, [min3, max3]);
